...
describe("prequalification rules", () => {
  ...
  it("Feature: clearway, Property 1: SGA is not an unconditional rejection", () => {
    fc.assert(
  ...
  it("Feature: clearway, Property 2: blindness selects the applicable SGA threshold", () => {
    expect(
      evaluateSga(
  ...
  it("Feature: clearway, Property 3: self-employment never compares gross revenue", () => {
  ...
  it("Feature: clearway, Properties 4-6: duration and recent work follow independent age rules", () => {
  ...
  it("Feature: clearway, Property 7: ambiguous credits remain uncertain", () => {
